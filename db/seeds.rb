...
Message.create!(to_id: acc.id, from_id: acc.id, to_name: "John Doe", from_name: "John Doe", subject: "Hello", body: "Hi. Hey.")
Message.create!(to_id: acc.id, from_id: acc2.id, to_name: "John Doe", from_name: "Jane Doe", subject: "New Program", body: "Hello, I was reaching out to you to see if you are interested in our new Graduate program that we have created. Its for new students looking to do Machine Learning. Please reply if you are interested and want to learn more.")
