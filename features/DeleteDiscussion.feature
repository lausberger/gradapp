Feature: Allow the user to delete a Discussion post
  ...
  Scenario: Delete the root discussion post
    ...
    And I should be redirected to the discussion homepage
  ...
  Scenario: Delete a reply to a discussion post
    ...
    And I should be redirected to the discussion page for the discussion with title "Any recommendations on program" authored by "Jack Stockley"
